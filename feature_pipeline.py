...
def engineer_features(df):
    ...
    # RT-Feature: Aktueller Bewölkungsgrad (bereits vorhanden als cloud_cover)
    # Keine extra Berechnung nötig, aber wir benennen es klar
    df["cloud_cover_rt"] = df["cloud_cover"]

    # Label: Hat es in den NÄCHSTEN 2 Stunden geregnet?
...
def save_features_locally(df, output_dir="data"):
    """Speichert Features als Parquet (lokaler Ersatz für Featurestore)."""
...
if __name__ == "__main__":
    ...
    print("Daher werden Features lokal als Parquet gespeichert.")
    print()
